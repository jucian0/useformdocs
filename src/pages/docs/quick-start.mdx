...
<DefaultSeo
  title="Quick Start"
  titleTemplate="Quick Start | useForm"
...
- Easy to use - useForm is very easy to use, you can use it without any library, just import it and use it.
...
> Dot notation is the same as the object property. For example, if you want to create an object with a property called `name` with a nested property called `firstName` you can write `name.firstName`.
